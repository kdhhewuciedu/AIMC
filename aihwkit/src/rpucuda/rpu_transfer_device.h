 ...
 */
 ...
 public:
   ...
   bool getHasSwitchedTile() const { return has_switched_tile_; }
   void setHasSwitchedTile(bool flag) { has_switched_tile_ = flag; }
   void set_flags_cpp(bool trigger_tile_switch_flag) override {
    trigger_tile_switch_flag_ = trigger_tile_switch_flag;
}
  ...
  //  bool trigger_tile_switch =  false;
 protected:
   ...
   std::vector<int> tiki_transfer_every_vec_;
   mutable std::vector<int> transfer_lower_;
   mutable std::vector<int> transfer_upper_;
   mutable bool transfer_ranges_initialized_ = false;   
   bool fully_hidden_ = false;
   bool has_switched_tile_ = false;
   bool trigger_tile_switch_flag_ = false;
   int tile_switch_rounds_done_ = 0;         
   int max_tile_switch_rounds_ = 1; 
   int current_tile_idx_ = 0;
